...
void send8BitLCD(char D){
	//dem D and so hoc voi 2^i de biet bit thu i=0 hay !=0
	//tim gia tri cac bit
...
int main(void)
{
  ...
  MX_GPIO_Init();
	...
	//xoa noi dung co san tren LCD
	sendCMD2LCD(0x01);
	//Bat hien thi man hinh, tat con tro
	sendCMD2LCD(0x0C);
	//Viet chuoi
	sendString2LCD("Thi LTN");
	//xuong dong
	sendCMD2LCD(0x38);	//bat che do 2 dong
	sendCMD2LCD(0xC0);	//xuong dong 2
	sendString2LCD("Le Quoc Duy");
